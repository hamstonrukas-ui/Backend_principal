...
const FRAUD_PROTECTION = {
  ...
  maxFailedPaymentAttempts: 2 // bloqué après ce nombre de tentatives ratées (mauvais ID/numéro)
};
  ...
  if (!TRANSACTION_ID_REGEX.test(id)) {
    return {
      ...
      error: "Ce Transaction ID ne ressemble pas à un vrai identifiant de transaction. " +
             "Format attendu, par exemple : MP250726.1900.H23086 (tel qu'il apparaît dans le SMS de confirmation). " +
